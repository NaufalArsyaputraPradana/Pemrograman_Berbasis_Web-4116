...
function addCartClicked(event) {
  ...
  var title = shopProducts.getElementsByClassName("product-nama")[0].innerText;
  var price = shopProducts.getElementsByClassName("price")[0].innerText;
  var productImg = shopProducts.getElementsByClassName("product-gambar")[0].src;
...
function addProductToCart(title, price, productImg) {
  ...
  var cartItemsNames = cartItems.getElementsByClassName("cart-product-nama");
  ...
  var cartBoxContent = `
              ...
              <div class="detail-box">
                <div class="cart-product-nama">${title}</div>
